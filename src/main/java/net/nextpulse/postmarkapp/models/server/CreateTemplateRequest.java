...
public class CreateTemplateRequest {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", required = true, value = "The friendly display name for the template.")
   ...
   * @return subject
  **/
  @ApiModelProperty(example = "null", required = true, value = "The Subject template definition for this Template.")
